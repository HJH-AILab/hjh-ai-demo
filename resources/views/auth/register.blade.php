                ...
                <div class="card-body">
                    <form id="loginform" name="loginform" method="POST" action="{{ route('register') }}">
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div role="alert" id="element" aria-live="assertive" aria-atomic="true" class="toast fade hide" data-autohide="true">
                        ...
                        <div class="form-group row mb-0">
                            ...
                            <div role="alert" id="element1" aria-live="assertive" aria-atomic="true" class="toast fade hide" data-autohide="true">
                                <div class="toast-header">
